...
import com.mastek.dna.config.ProfileApplication;
...
public class ProfileEndpointSuper
{
	@Autowired
	protected TestRestTemplate restTemplate;

	private final static Logger LOGGER = LoggerFactory.getLogger(ProfileEndpointSuper.class);
